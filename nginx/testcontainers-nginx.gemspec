...
require_relative "lib/testcontainers/nginx/version"

Gem::Specification.new do |spec|
  spec.name = "testcontainers-nginx"
  spec.version = Testcontainers::Nginx::VERSION
  ...
  spec.metadata["homepage_uri"] = "#{spec.homepage}/blob/main/nginx"
  spec.metadata["source_code_uri"] = "#{spec.homepage}/blob/main/nginx"
  spec.metadata["changelog_uri"] = "#{spec.homepage}/blob/main/nginx/CHANGELOG.md"

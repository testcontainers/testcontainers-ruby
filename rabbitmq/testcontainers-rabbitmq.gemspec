...
require_relative "lib/testcontainers/rabbitmq/version"
...
Gem::Specification.new do |spec|
  ...
  spec.metadata["homepage_uri"] = "#{spec.homepage}/blob/main/rabbitmq"
  spec.metadata["source_code_uri"] = "#{spec.homepage}/blob/main/rabbitmq"
  spec.metadata["changelog_uri"] = "#{spec.homepage}/blob/main/rabbitmq/CHANGELOG.md"
